		...
		While ($Flag) {
			...
			$response.items | ForEach-Object {    
				if ($_.ipv4Addresses.Count -ne 0) {
					if ($_.ipv4Addresses.Contains($HostName)) {						
...
function IsolateEndpoint {
 ...
 Catch {
		...
		ElseIf ($_.Exception.Message -eq "EndPointNotFound") {
			Write-Output "Endpoint with IP `"$HostName`" was not found."
			Write-Output "Provide a valid IP".
			Throw "ExecutionFailure"
		}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCeqfoc36yKhWgUtfMhtsMoV8
# uoSggg8CMIIEyjCCA7KgAwIBAgIQVYges/w+aNZI0+oa53/ULjANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUxcZSkhaI
# 7bbDSc+ovVaBD/l5Xv8wDQYJKoZIhvcNAQEBBQAEggEAocwmON+mkeeVdWs4raiS
# U0cBpWUG2IMA/L1Bnrvylm/UM+8no2AKJ9wWr6s/ir1RlNuatr06UCeTANgnqFw6
# NA5fT2b/n4tVEjn0o+Uu2omJcjMCMxxK5Pzj9xMo5HMauVe8ysXDWibOhzbULzvD
# j0qVTEA2ZI7qHP4gWZdGFa/BMSYqFoDNcUa0XmL2y8HlsVUFV82DNzrWmfGQiQMF
# ARxq/Puxv02o66H/pI+zsCsVp/d1Sx6x2yENAOoLtNoOz867YkKfYn7UYfoyloVY
# qZsVyDAjZJ6KEQYRgL9fHzoRowqh4zRC5DNgkTGv2PBS4v+i1/4FVptPaswEChkf
# tA==
