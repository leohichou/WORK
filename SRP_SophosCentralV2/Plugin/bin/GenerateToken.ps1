...
function GenerateToken{
    ...
    try
	{
        if($ProxyFlag -eq 0)
		{
		    $Output = Invoke-RestMethod -Uri $Url -Method Post -Headers $Header -Body $Body -ContentType "application/x-www-form-urlencoded" -SkipCertificateCheck
        }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUHJmzSOtl/tDvzZSBazh6BjMq
# lMaggg8CMIIEyjCCA7KgAwIBAgIQVYges/w+aNZI0+oa53/ULjANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUvWeGYlPN
# 9QGo6nTt2qg8XQJyQH8wDQYJKoZIhvcNAQEBBQAEggEAUV6bvF91TJmEOjVBM8EJ
# f3xbUYVSomznRb2kxIzfkCSwygUztIaAaRPk4+hUbo3967ggh9FF4eCU5pCtead8
# fTbcl+vfiIs3rvP37mMxu0jt/87DuDRVsmQAGltgj1yt/zavcm/qYnmnMUVWY4lx
# z+Lwnq1RjHNtIM0lasQT5ibTcP7dwsUtR3NmjKkryR3W8p7xKCKUmFHlZP58mBAY
# lq7DYsMwWmef7Ykv63HNFJlygn9Hl4KGCZLHK16Pxw6MsUDQyT0fXXmZDqBjNipa
# +eqXddWjR4tAWKT4rUcvDqdkeU2cYxGcC3bwX5VAdqRe5by8bYE7b+Wm1RI0m8mY
# qw==
