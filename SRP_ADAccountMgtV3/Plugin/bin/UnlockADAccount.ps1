...
#Function to Unlock ADUser Account
function UnlockADUserAccount{
    try
    {
        $AccountName = $global:TargetAccount

       
            Unlock-ADAccount -Identity $AccountName -Server $global:TargetDomain -Credential $global:Creds -ErrorAction Stop
            $UnlockDetails = Get-ADUser -Server $global:TargetDomain -Identity $AccountName -Properties "LockedOut" -Credential $global:Creds
        
        if($UnlockDetails.LockedOut -ne "True") {
            Write-Host "Account successfully Unlocked"
        }           
    }
    catch
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU4WakwlTVW7NimCzV6lY48alt
# FoOggg8CMIIEyjCCA7KgAwIBAgIQVYges/w+aNZI0+oa53/ULjANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU9Wn+4fcJ
# u1rZhIP/oC5OdiaX6RMwDQYJKoZIhvcNAQEBBQAEggEARM5hpcw/k46m9RklI7bg
# buYH09hgYXbTXLXFQjCJ+ODOnn2YC6oURt7LF1l8GadP3dJP/O7QpeQ+Xkv2z6tw
# FV/vqq0BKcLvmKihRFPtD23m2JjAvca1EavwCcdPo1Iai4O+u9HGoc3x+qU7GcTL
# 0lAlwTpUgiTj7/LOc79V0gipWTuClr5JJIzy9D2WHGGzvBwtlll6Rpe8LHt7Ra5Y
# vU2EdlnOTr3RiTueLUIDf2t60l96q3Ed4jg6O0KgO3Z7zE/BegxJA3PGUrI4svzG
# dagJ59crdPZsl9OWkComzMOgsrLahhoQFuyp1n32Ac/qq1GDBYSdz5PYTQtG8zqP
# Bg==
