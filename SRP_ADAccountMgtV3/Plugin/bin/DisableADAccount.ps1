...
#Function to Disable ADUser Account
function DisableADUserAccount {

     if($global:Details.Enabled -ne "True") {
         Write-Host "Account $global:TargetAccount is already Disabled"
         exit
     }
     ...
     try
     {
        $AccountName = $global:TargetAccount
            ...
            Disable-ADAccount -Identity $AccountName -Server $global:TargetDomain -Credential $global:Creds -ErrorAction Stop
            $EnableDetails = Get-ADUser -Server $global:TargetDomain -Identity $AccountName -Properties "Enabled" -Credential $global:Creds
         
         if($EnableDetails.Enabled -ne "True") {
             Write-host "Account successfully disabled"
         }           
     }
     catch
     {
...
#Function call
DisableADUserAccount
# SIG # Begin signature block
# MIIRzQYJKoZIhvcNAQcCoIIRvjCCEboCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkKnZLekg/B4Qeqm4mbtkcJcr
# /QSggg8CMIIEyjCCA7KgAwIBAgIQVYges/w+aNZI0+oa53/ULjANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU8QqomJJi
# aO5atJ+ak/OVYt94+zUwDQYJKoZIhvcNAQEBBQAEggEAkbBN9y4vAMgI/J4Uf21y
# jvKt24ih0iHeWnsSf75MJEP3GDzC6xD3P/kCHlUok0dW5ce3PVxmPmpQ5/6rNCsa
# 9+NrWJCXO6mvwjTABNwr6UOJdisONzgHse7fYcfWFWWOui7gjBtPyuhdOktOKigr
# Z6S4KYH+POZXGqbzHnmIKA2fVqSdbaeYS41Dsd/cjwNqVG7rCB8As5bt/XiJDO91
# 38HLHtWt79OKrWjNtMPTyi5FXae1Qy4xwZlITsmX6D6dG+NufRv/WcMCybBwwDal
# CH+8gbnnLCMUZfHAp9PQh/l4k5y7A2n/lED13ojJuflL+vazSKhJnc/paaMDwuMc
# zw==
