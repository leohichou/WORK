...
function GetConfigFileData([string]$FilePath) {
	try{
		if (!(Test-Path -Path $FilePath)){
            ...
            $ConfigContent = @{}
            $ConfigFileContent.psobject.properties | Foreach { $ConfigContent[$_.Name] = $_.Value }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUSZkw2KUgxeNpvPngm23ed9lc
# 6IWggg8CMIIEyjCCA7KgAwIBAgIQVYges/w+aNZI0+oa53/ULjANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUZMfiaTEC
# kKZofmgaBJdONiDaYZgwDQYJKoZIhvcNAQEBBQAEggEApwXZ9iqWcPXro6zIZx6q
# ouoddkwca5HZAvTj7exNHLQv6oMNchMmkqdR4FABwWPN7lkapzgR/1nOyPPlkeQC
# Y6GIS1Om7TZZwzzTE5A6aJh+V3Y/SoA6bn4f+i8M3RPZWBwOj/1gUa8ASkc/fNAC
# elub1p8zCk/nbUTus2nT16bxA0H3oaE24agGF+hHuc7BDqi+na/kFHZ053zX8niP
# zfMJEnXMyGQXPyoZLVh0gETG9+1yd4lAY6q49h22Av9N4RFLVMay8b6hdv5FPwYi
# vgEs9BICiajqtTZsuBXe5zFlpfKWTPj79LuLv3r+sZWRXIbsS+lFweOyK5x9jnm5
# LQ==
