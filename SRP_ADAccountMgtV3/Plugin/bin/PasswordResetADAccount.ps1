...
# 4. Reset Password for AD User Account
# 
#==========================================#
...
{   
    try
    {
        ...
        $SecuredNewPwd =  ConvertTo-SecureString -AsPlainText -Force -String $TemporaryPassword


         
            Set-ADAccountPassword -Identity $AccountName -Server $global:TargetDomain -Credential $global:Creds -Reset -NewPassword $SecuredNewPwd -ErrorAction Stop
            Set-ADUser -Identity $AccountName -Credential $global:Creds -Server $global:TargetDomain -ChangePasswordAtLogon $True
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUC2lkn6BnlIqP24Ee/eMSLN7+
# Hc+ggg8CMIIEyjCCA7KgAwIBAgIQVYges/w+aNZI0+oa53/ULjANBgkqhkiG9w0B
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUhtS5SeqJ
# SMVlgcjrsOg2PSb7AjEwDQYJKoZIhvcNAQEBBQAEggEAUX1EU+VcQaE2XiPd9Q9C
# MUM2fb4V+eamLGViHYapF8tgjHGyDJRdGG3vvnxnku0OecupV1YnGS26aNeSGBL9
# cVXqnnTaTzsGGCEDsb0sqVIOflPtD1mWy1+In642KE2Fe0/31464ddVudL75vpz+
# 4zs8ZpY4JnzbAQEhpEZG/6NfbiNGByl0oUqkptXwC9D6jPxFoZNbaC/U9V4zlvD+
# LIAVuOlz4TVid5wz+TAHRoTWR6hM4JK4OTZHVp6kXpYx6utCL+Xyvr3pflv4fPRO
# D0Cbm2aLxEcJ1Ck7KFxlfLwzS1fT9breEEdNGpTTURvdDCJchyaL6yrjQkylC21d
# fw==
